...
using MaxMaster.Providers;
using MaxMaster.Results;
...
namespace MaxMaster.Controllers
{
    ...
    public class AccountController : ApiController
    {
        ...
        // POST api/Account/ForgotPassword?email=%2F
        ...
        public async Task<IHttpActionResult> GetExternalLogin(string provider, string error = null)
        {
            ...
            if (hasRegistered)
            {
                ...
                AuthenticationProperties properties = ApplicationOAuthProvider.CreateProperties(user.UserName,null,null,null,null,null);
